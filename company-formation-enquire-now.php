          ...
          <div class="pbmit-title-bar-content-inner">
            <div class="pbmit-tbar">
              <div class="pbmit-tbar-inner container">
                <h1 class="pbmit-tbar-title">Company Formation Enquire Now</h1>
              </div>
            </div>
        ...
        <div class="container">
          <div class="row cntrrr">
                ...
                <form method="post" id="contact-form" action="send.php">
                  <div class="row"> 
                    <div class="col-md-12 col-lg-12">
                      ...
                      <div class="col-md-12 col-lg-12">
                      <input type="text" name="name" class="form-control" placeholder="Country" required>
                    </div>
                    <div class="col-md-12 col-lg-12">
                      ...
                      <div class="col-md-12 col-lg-12">
                   <select name="CompanyType" class="form-control" aria-invalid="false">
            ...
            <option value="Ultimate">Ultimate</option>
                                ...
                                <div class="col-md-12 col-lg-12">
                        <select name="CompanyType" class="form-control" aria-invalid="false">
            <option value="Add-on Services Type">Add-on Services Type</option>
            <option value="Company formation without travel to Georgia / On the basis of Power of Attorney.">Company formation without travel to Georgia / On the basis of Power of Attorney.</option>
            <option value="Nominee Director Services For 1 Year.">Nominee Director Services For 1 Year.</option>
            <option value="Nominee Shareholder Services For 1 Year.">Nominee Shareholder Services For 1 Year.</option>
            <option value="Tax Declaration- Preparing &amp; Filing For 1 Year.">Tax Declaration- Preparing &amp; Filing For 1 Year.</option>
          </select>
                    </div>
                    ...
                    <div class="col-md-12">
                      <textarea name="message" cols="40" rows="4" class="form-control" placeholder="Description" required=""></textarea>
                    </div>
                    <div class="col-md-12 col-lg-6">
                      <button type="submit" class="pbmit-btn pbmit-btn-global pbmit-btn-shape-round w-100">
