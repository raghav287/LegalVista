...
// If the selected category doesn't exist in our actual categories, reset it.
if ($selectedCategory !== '' && !isset($categoryCounts[$selectedCategory])) {
    $selectedCategory = '';
}
...
<head>
    ...
    <meta name="description"
        content="Explore Legal Vista articles and resources on company formation, tax residency, resident permits, compliance updates, and practical guides for doing business in Georgia." />
    <meta name="keywords"
        content="Legal Vista articles, Georgia company formation, tax residency Georgia, resident permit Georgia, legal updates Georgia, business guides Georgia" />
                    ...
                    <div class="articles-main">
                        <div class="articles-results-bar">
                            <div class="articles-results-text">
                                ...
                                Showing <?php echo count($pageArticles); ?> of <?php echo $totalArticles; ?>
                                article<?php echo $totalArticles === 1 ? '' : 's'; ?>
                                <?php if ($searchQuery !== ''): ?>
                        ...
                        <div class="articles-list">
                            ...
                            <article class="article-card">
                                <a class="article-card-image"
                                    href="<?php echo htmlspecialchars('article?slug=' . $article['slug'], ENT_QUOTES, 'UTF-8'); ?>">
                                    <img src="<?php echo htmlspecialchars($articleImage, ENT_QUOTES, 'UTF-8'); ?>"
                                        alt="<?php echo htmlspecialchars($article['title'], ENT_QUOTES, 'UTF-8'); ?>" />
                                </a>
                                <div class="article-card-content">
                                    <div class="article-card-meta">
                                        <?php echo htmlspecialchars(implode(', ', $articleCategories), ENT_QUOTES, 'UTF-8'); ?>
                                    </div>
                        ...
                        <nav class="articles-pagination" aria-label="Articles pagination">
                            ...
                            <a class="articles-page-link<?php echo $page === $currentPage ? ' is-active' : ''; ?>" href="<?php echo htmlspecialchars(buildArticlesUrl([
                                                'search' => $searchQuery,
                            ...
                            <a class="articles-page-link next-link" href="<?php echo htmlspecialchars(buildArticlesUrl([
                                                'search' => $searchQuery,
                                                'category' => $selectedCategory,
                                                'page' => $currentPage + 1,
                                            ]), ENT_QUOTES, 'UTF-8'); ?>">
                    ...
                    <aside class="articles-sidebar">
                        <div class="articles-widget">
                            ...
                            <form class="articles-search-form" method="get" action="articles-and-resources">
                                ...
                                <input type="hidden" name="category"
                                    value="<?php echo htmlspecialchars($selectedCategory, ENT_QUOTES, 'UTF-8'); ?>" />
                                <?php endif; ?>
                                <input class="articles-search-input" type="search" name="search"
                        ...
                        <div class="articles-widget">
                            ...
                            <div class="articles-category-list">
                                ...
                                <a class="articles-category-link<?php echo $selectedCategory === $categoryName ? ' is-active' : ''; ?>"
