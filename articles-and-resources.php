                            ...
                            <div class="articles-list">
                                <?php foreach ($pageArticles as $article): ?>
                                    ...
                                    <article class="article-card">
                                        <a class="article-card-image" href="<?php echo htmlspecialchars('article?slug=' . $article['slug'], ENT_QUOTES, 'UTF-8'); ?>">
                                        ...
                                        <div class="article-card-content">
                                            ...
                                            <h2 class="article-card-title">
                                                <a href="<?php echo htmlspecialchars('article?slug=' . $article['slug'], ENT_QUOTES, 'UTF-8'); ?>">
