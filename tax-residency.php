                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <select name="service" id="service" class="form-control form-control-lg" required>
                                        ...
                                        <option value="Tax Residency" selected>Tax Residency</option>
  ...
  <li>Stateless persons</li>
                            ...
                            <div class="package">
                                <div class="row cnt">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="btnnnnnn">
                                            <p><a href="" data-service="Tax Residency" data-bs-toggle="modal" data-bs-target="#exampleModal4"
        ...
        $(document).ready(function() {
            $('.price-button[data-bs-target="#exampleModal4"]').on('click', function(e) {
                e.preventDefault();
                var service = $(this).data('service') || 'Tax Residency';
                $('#service').val(service);
