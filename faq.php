...
<div class="accordion" id="accordionPanelsStayOpenExample">
  <div class="accordion-item">
    ...
    <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
      ...
      <p>To begin, we typically require basic company information, transaction history, payroll details, and any relevant tax documentation. We will guide you through the process step by step.</p>
      </div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
      <div class="accordion-body">
      <p>In our Standard and Enterprise packages, we handle all aspects of VAT compliance, from registration to reporting, ensuring your business adheres to all Georgian VAT regulations.</p>
      </div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingThree">
      <div class="accordion-body">
      <p>Yes! You can easily upgrade your package as your business grows or your accounting needs become more complex. Our team will help you transition smoothly.</p>
      </div>
    </div>
  </div>
  ...
  <div class="accordion-item">
    ...
    <div id="panelsStayOpen-collapsefor" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingfor">
      <div class="accordion-body">
      <p>We submit reports to the Georgian Statistics Department as required, ensuring your business remains compliant with all reporting obligations.</p>
      </div>
    </div>
  </div>
