...
function handleStickyHeader() {
  if (window.pageYOffset > sticky) {
    header.classList.add("sticky");  // Add class "sticky" when header scrolls past its original position
  } else {
    header.classList.remove("sticky");  // Remove class "sticky" when back at the top
  }
}