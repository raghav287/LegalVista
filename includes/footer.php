            ...
            <div class="row">
                <div class="pbmit-footer-widget-col-3">
                    <div class="widget">
                        ...
                        <p class="pbmit-footer-text"> Legal Vista Ltd, a premier law firm founded in 2017, offers
                            bespoke legal services to expatriates looking to set up base in Georgia. We offer a gamut of
                            company start up services to kick start your business and assist in its growth. <br>
                            <br>
                            Our company mission is to provide our esteemed clients with quality services in a
                            transparent manner at affordable costs.
                        </p>
                    </div>
                </div>
                    ...
                    <div class="widget">
                        ...
                        <div class="pbmit-footermenu-wrapper">
                            <ul>
                                ...
                                <li><a href="individual-entrepreneur">Individual Entrepreneur</a></li>
                ...
                <div class="pbmit-footer-widget-col-4">
                    <div class="widget">
                        ...
                        <ul class="contactus-">
                            ...
                            <li> <i class="fa fa-phone" aria-hidden="true"></i><a href="tel:+995599848487"> +995
                                    599848487</a> Mobile / Whatsapp </li>
                            <li> <i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:+995599848486"> +995
                                    599848486</a> </li>
                            <li><i class="fa fa-envelope" aria-hidden="true"></i><a
                                    href="mailto:info@legal-vista.com">info@legal-vista.com</a></li>
