...
document.addEventListener("DOMContentLoaded", function() {
    ...
    syncFixedHeader();
    window.addEventListener("scroll", syncFixedHeader, {
        passive: true
    });
    ...
    <div class="container">
      <div class="d-flex justify-content-between">
        ...
        <div class="pbmit-social-links-wrapper">
                    <ul class="call-icon">
                        <li> <i class="pbmit-base-icon-phone"></i> <a href="tel:+995599848487"
                                style="padding-right: 10px !important;">
                                +995599848487</a> </li>
                        <li> <i class="pbmit-base-icon-envelope"></i> <a
                    ...
                    <div class="site-navigations  mrrr">
                        <nav class="main-menu navbar-expand-xl navbar-light">
                            <div class="navbar-header">
                                <!-- Toggle Button -->
                                <button class="navbar-toggler" type="button"> <i class="pbmit-attorco-icon-bars"></i>
                                </button>
                            </div>
